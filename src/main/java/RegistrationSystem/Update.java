...
public class Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Update", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Serif", 0, 18))); // NOI18N
...
try {
    ...
    if (index < 0 || index >= collegeModel.getRowCount()) {
        // Check if index is within valid range
        JOptionPane.showMessageDialog(null, "Invalid index");
        return;
    }

    collegeModel.setValueAt(college, index, 1);
    courseModel.setValueAt(college, index, 1);
    courseModel.setValueAt(course, index, 2);
    courseModel.setValueAt(miscs, index, 3);
    studentModel.setValueAt(lastname, index, 1);
    studentModel.setValueAt(firstname, index, 2);
    studentModel.setValueAt(mobileNumber, index, 3);
    studentModel.setValueAt(email, index, 4);
    studentModel.setValueAt(college, index, 5);
    studentModel.setValueAt(course, index, 6);
    this.dispose();
